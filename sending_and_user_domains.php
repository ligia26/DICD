<?php
/*  map_user_domains_countries.php  */
...
/* A.  save / update a user-domain’s country list
       (over-writes whatever was there before) */
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_mapping'])) {
    ...
    header("Location: map_user_domains_countries.php");
    exit;
}
...
/* active user-domains with their current country CSV */
$res = $conn->query(
...
<div class="card mb-4"><div class="card-body p-4">
  ...
  <form method="post">
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-9">
        <select class="form-select" name="user_domain" required>
